  ...
  return (
    <WebView
      ...
      source={{
        ...
        // Ensure an https baseUrl is used to avoid infinite loading on production due to https://github.com/atimsparks/react-native-stripe-checkout-webview/issues/10
